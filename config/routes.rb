SesusoEms::Application.routes.draw do
  ...
  get 'order_gift_card_workflow/select_gift_card_product', to: 'order_gift_card_workflow#select_gift_card_product'
  get 'order_gift_card_workflow/receive_gift_card_product', to: 'order_gift_card_workflow#receive_gift_card_product'
  ...
  get 'orders/send_gift_card_activation_mail', to: 'orders#send_gift_card_activation_mail'
